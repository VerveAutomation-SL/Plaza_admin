...
import { useUser } from "../auth/AccessControlWrapper";

export default function UserDropdown() {
  const [isOpen, setIsOpen] = useState(false);
  const [isLoggingOut, setIsLoggingOut] = useState(false);
  const router = useRouter();
  const { userName, userRole, useremail } = useUser(); // ✅ Get from context
  ...
  // useEffect to redirect after cookie is removed
  useEffect(() => {
    if (isLoggingOut) {
